...
define("DB_HOST", "remotemysql.com"); //Сервер базы данных
define("DB_USERNAME", "eNBVoY0zva"); //Пользователь базы данных
define("DB_PASSWORD", "yytxBsPygC"); //Пароль от пользователя базы данных
define("DB_NAME", "eNBVoY0zva"); //Имя базы данных
define("APP_SECRET", "arSS85Nr6x550WKcqvg4"); //Защищенный ключ приложения
define("SERVICE_KEY", "b1ec099db1ec099db1ec099d0fb195ec3ebb1ecb1ec099dd0919c5d6166632d3e74b5c2");
